...
-- Procédure : Statistiques par organisation
CREATE PROCEDURE sp_get_organization_stats(IN p_org_id VARCHAR(36))
BEGIN
    SELECT 
    ...
    LEFT JOIN encounters e ON o.id = e.organization_id
    WHERE o.id = p_org_id
